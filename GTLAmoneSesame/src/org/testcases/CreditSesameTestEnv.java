...
public class CreditSesameTestEnv {
	...
	public void Desktop1a() {
		...
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes");
...
//	@Test--
	public void Desktop1b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true"); 
	...
	public void Desktop2a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes&doTUping=true&social=partial"); 
...
//	@Test--
	public void Desktop2b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes&doTUping=true&social=partial&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "91791", "1945, GARVEY, WEST COVINA, CA", "Test", 
	...
	public void Desktop3a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes&doTUping=true"); 
	...
	public void Desktop3b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://personal-loans.creditsesame.com.test.quinstreet.net/creditsesame/service.jsp?dping=yes&doTUping=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
