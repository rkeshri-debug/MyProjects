...
public class SecureamoneProdEnv {

	
	
	@Test
	public void Desktop() {
		Logger.addTestCase("SecureAmone","Verify all valid Parameters : Redirects to 9 Digit SSN and Thankyou page");
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com/amone/service.jsp?dping=yes&qacs=720&doTUPing=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true&cs=d&vc=15452310"); 
