...
public class SecureAmoneTestEnv {
...
//	@Test
	public void Desktop1a() {
		...
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&doTUPing=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true"); 
...
//	@Test--
	public void Desktop1b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
...
//	@Test--
	public void Desktop2a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=b&doTUPing=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
...
//	@Test
	public void Desktop2b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=b&doTUPing=true"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "91791", "1945, GARVEY, WEST COVINA, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
...
//	@Test--
	public void Desktop3a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=c&doTUPing=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
	...
	public void Desktop3b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=c&doTUPing=true"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
	...
	public void Desktop4a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=d&doTUPing=true&cps=true"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
			"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
...
//	@Test--
	public void Desktop4b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&cs=d&doTUPing=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
...
//	@Test
	...
	//	https://secure.amone.com/amone/m/service.jsp?&dping=yes&qacs=720
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&qacs=720&doTUping=true&cps=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true"); 
...
//	@Test--
	public void Mobile2a() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&doTUping=true&social=partial&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
...
//	@Test
	public void Mobile2b() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://guidetolenders.test.quinstreet.net/personalloans/service.jsp?dping=yes&doTUping=true&social=partial"); 
		Mobile.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "91791", "1945, GARVEY, WEST COVINA, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
...
//	@Test--
	public void Mobile3a() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&doTUping=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
...
//	@Test
	public void Mobile3b() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://secure.amone.com.test.quinstreet.net/amone/service.jsp?dping=yes&doTUping=true"); 
		Mobile.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "111", "11", "1111");	
	}
	@AfterMethod
