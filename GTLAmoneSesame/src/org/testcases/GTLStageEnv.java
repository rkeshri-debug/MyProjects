...
public class GTLStageEnv {
	...
	public void Desktop1a() {
		...
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes"); 
...
//	@Test--
	public void Desktop1b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&qacs=720&doTUping=true&cs=d&skipTE=true"); 
...
//	@Test--
	public void Desktop2a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true&social=partial&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true&cs=d"); 
...
//	@Test
	public void Desktop2b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true&social=partial&cps=true&cps=true"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "91791", "1945, GARVEY, WEST COVINA, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "", "", "1111");	
	}
...
//	@Test
	public void Desktop3a() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true"); 
...
//@Test--
	public void Desktop3b() {
		...
		DriverFactory.readyForTestCase();
		DriverFactory.initiateDriver();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
		PersonalLoans.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "92692", "28083, GEORGETOWN, MISSION VIEJO, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "", "", "");	
	}
...
//	@Test
	public void Mobile1b() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122&skipTE=true"); 
...
//@Test
	public void Mobile2a() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true&social=partial"); 
...
//	@Test--
	public void Mobile2b() {
		...
		DriverFactory.initiateDriver();
		DriverFactory.changeMobileView();
		DriverFactory.driver.get("http://guidetolenders.quinstage.com/personalloans/service.jsp?dping=yes&doTUping=true&social=partial&CCID=20115243203619638&QTR=ZZf201006101154240Za20115243Zg255Zw0Zm0Zc203619638Zs10267ZZ&CLK=506190523133554122"); 
		Mobile.PersonalLoanForm("Debt Consolidation", "20000","Excellent", "Employed", "20000", "Own", "1 to 2 years", "91791", "1945, GARVEY, WEST COVINA, CA", "Test", 
				"Test", "4-4-1989", "650", "578", "7700", "", "", "1111");	
	}
